...
The current decoder still has documented limits around broader compressed-transfer-syntax parity, but the supported runtime paths no longer depend on Rust helper binaries.
